...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function tu(e10) {
        return e10.nextUrl.pathname.startsWith("/dashboard") && !e10.cookies.getAll().some((e11) => e11.name.startsWith("sb-") && e11.name.endsWith("-auth-token")) ? Z.redirect(new URL("/auth", e10.url)) : Z.next();
      }
      RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)`), RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), e.s([], 85835), e.i(85835), e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|favicon.ico|.*.(?:svg|png|jpg|jpeg|gif|webp)$).*)"] }, "middleware", () => tu], 99446);
      var tc = e.i(99446);
...
var BuildId = "1NyvFXYkaaedcoAj0oLN7";
