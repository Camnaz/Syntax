/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: feb54ed38c5df29eff689e126973a239)
// Runtime types generated with workerd@1.20260312.1 2025-09-11 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_SYNTAX_API_URL: string;
		NEXT_PUBLIC_DEV_MODE: string;
		NEXT_PUBLIC_OBSERVER_FREE_VERIFICATIONS: string;
		NEXT_PUBLIC_FINNHUB_API_KEY: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_WEBHOOK_SECRET: string;
		STRIPE_PRICE_OPERATOR: string;
		STRIPE_PRICE_SOVEREIGN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "NEXT_PUBLIC_SYNTAX_API_URL" | "NEXT_PUBLIC_DEV_MODE" | "NEXT_PUBLIC_OBSERVER_FREE_VERIFICATIONS" | "NEXT_PUBLIC_FINNHUB_API_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRICE_OPERATOR" | "STRIPE_PRICE_SOVEREIGN" | "STRIPE_PRICE_INSTITUTIONAL" | "NEXT_PUBLIC_SITE_URL" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
